...
// constructor
Item::Item(const string& n, const string& d, ItemType t, ItemRarity r) : name(n), description(d), type(t), rarity(r) { }
...
cout << "\n=== Item Information ===\n";
    ...
    cout << "Rarity: ";
    switch(rarity) {
        case ItemRarity::COMMON: cout << "Common"; break;
        case ItemRarity::UNCOMMON: cout << "Uncommon"; break;
        case ItemRarity::RARE: cout << "Rare"; break;
        case ItemRarity::EPIC: cout << "Epic"; break;
        case ItemRarity::LEGENDARY: cout << "Legendary"; break;
    }
...
Consumable::Consumable(const std::string& n, const std::string& d, ItemType t,
    ...
    : Item(n, d, t, r), effectPower(power * getRarityMultiplier(r)) {}
