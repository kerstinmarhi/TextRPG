...
Monster::Monster(const string& n, int hp, int a, double cc, double cm, const string& d, int xpVal)
    : name(n), health(hp), attackPoints(a), critChance(cc), critMultiplier(cm), description(d), xpReward(xpVal) {}
